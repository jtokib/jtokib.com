      ...
      <main>
        <section id="home" className="hero">
          ...
          <div className="hero-content block-dark">
            <h1><span className="highlight">TOKI BURKE</span> — MARKETING TECHNOLOGY</h1>
            <p className="hero-description">
              I build the marketing technology infrastructure that makes global enterprise campaigns actually work—across continents, consent frameworks, and compliance requirements. Eight years turning privacy complexity into clean attribution data that marketers can trust and legal teams can live with.
            </p>
            <div className="hero-buttons">
              <a href="#projects" className="btn btn-primary">View Projects</a>
              <a href="/fun" className="btn btn-secondary">Fun Stuff →</a>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="about-content">
              <div className="about-text">
                <p>
                  For the last eight years I&apos;ve helped build marketing technology infrastructure that most teams don&apos;t realize is hard until they try it themselves:
                </p>
              ...
              <div className="about-sidebar">
                <div className="fun-facts">
                  ...
                  <ul>
                    <li>13 years of Ocean Beach surf logs—built obsf.surf to actually analyze them</li>
                    <li>4 years teaching English in rural Okinawa, Japan (JET Program)</li>
                    <li>UC Davis Men&apos;s Swimming &amp; Diving Co-Captain</li>
                    <li>Led volunteer home-building trips to rural India with Go Longitude</li>
                    <li>Series 65 licensed—yes, the finance part stuck</li>
                  </ul>
                </div>
              </div>
            </div>
